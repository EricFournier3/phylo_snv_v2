...
process FASTP {
  ...
  fastp -i ${reads[0]} -I ${reads[1]} -o "${sample_name}_R1_001_trimmed_1.fastq.gz" -O "${sample_name}_R2_001_trimmed_2.fastq.gz"  -l 70 -x --cut_tail --cut_tail_mean_quality 20 --detect_adapter_for_pe --dedup  --thread 2 --json "${sample_name}.fastp.json"
